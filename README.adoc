= bash-functions image:https://github.com/daggerok/bash-functions/actions/workflows/ci.yml/badge.svg["Build Status", link="https://github.com/daggerok/bash-functions/actions/workflows/ci.yml"]
